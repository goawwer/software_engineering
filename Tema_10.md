...
## Вывод
 ...
 данном задании я впервые создал свое собственное исключение благодаря тому, что создал отдельный класс. Также пояснения работы этого кода находятся в комментариях.

...
В данном задании я придумал собсттвенное условие, благодаря которому, как мне кажется, повторил свои знания, связанные с листом и добавлением внего кортежа. Также познакомился с новым способом поиска максимального и минимального значений по ключу с помощью max(lines, key=len).
